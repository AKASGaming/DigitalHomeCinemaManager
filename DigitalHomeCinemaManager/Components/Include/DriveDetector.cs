...
namespace DigitalHomeCinemaManager.Components.Include
{
    using System;
    using System.IO;
                ...
                switch (m.WParam.ToInt32()) {
                    ...
                    case DBT_DEVICEQUERYREMOVE:
                        ...
                        if (devType == DBT_DEVTYP_HANDLE) {
                            // we could get the handle for which this message is sent 
                    ...
                    case DBT_DEVICEREMOVECOMPLETE:
                        ...
                        if (devType == DBT_DEVTYP_VOLUME) {
                            ...
                            if (devType == DBT_DEVTYP_VOLUME) {
                                ...
                                // we could unregister the notify handle here if we knew it is the
